...
pub mod rman {
    ...
    impl<'a> Bundle<'a> {
        ...
        pub fn chunks(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Chunk<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Chunk>>,
                >>(Bundle::VT_CHUNKS, None)
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Chunk>>,
                >>("chunks", Self::VT_CHUNKS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct BundleArgs<'a> {
        ...
        pub chunks: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Chunk<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> BundleBuilder<'a, 'b> {
        ...
        pub fn add_chunks(
            ...
            chunks: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Chunk<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Bundle::VT_CHUNKS, chunks);
        }
        #[inline]
    ...
    impl<'a> Chunk<'a> {
        ...
        pub fn compressed_size(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(Chunk::VT_COMPRESSED_SIZE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn uncompressed_size(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(Chunk::VT_UNCOMPRESSED_SIZE, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ChunkBuilder<'a, 'b> {
        ...
        pub fn add_compressed_size(&mut self, compressed_size: u32) {
            self.fbb_
                .push_slot::<u32>(Chunk::VT_COMPRESSED_SIZE, compressed_size, 0);
        }
        #[inline]
        pub fn add_uncompressed_size(&mut self, uncompressed_size: u32) {
            self.fbb_
                .push_slot::<u32>(Chunk::VT_UNCOMPRESSED_SIZE, uncompressed_size, 0);
        }
        #[inline]
    ...
    impl<'a> Directory<'a> {
        ...
        pub fn parent_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(Directory::VT_PARENT_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Directory::VT_NAME, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> DirectoryBuilder<'a, 'b> {
        ...
        pub fn add_parent_id(&mut self, parent_id: u64) {
            self.fbb_
                .push_slot::<u64>(Directory::VT_PARENT_ID, parent_id, 0);
        }
        #[inline]
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Directory::VT_NAME, name);
        }
        #[inline]
    ...
    impl<'a> File<'a> {
        ...
        pub fn directory_id(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(File::VT_DIRECTORY_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn language_mask(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(File::VT_LANGUAGE_MASK, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> FileBuilder<'a, 'b> {
        ...
        pub fn add_directory_id(&mut self, directory_id: u64) {
            self.fbb_
                .push_slot::<u64>(File::VT_DIRECTORY_ID, directory_id, 0);
        }
        #[inline]
        ...
        pub fn add_language_mask(&mut self, language_mask: u64) {
            self.fbb_
                .push_slot::<u64>(File::VT_LANGUAGE_MASK, language_mask, 0);
        }
        #[inline]
        ...
        #[inline]
        pub fn add_chunk_ids(
            &mut self,
            chunk_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u64>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(File::VT_CHUNK_IDS, chunk_ids);
        }
        #[inline]
        ...
        pub fn add_permissions(&mut self, permissions: u8) {
            self.fbb_
                .push_slot::<u8>(File::VT_PERMISSIONS, permissions, 0);
        }
        #[inline]
    ...
    impl<'a> Language<'a> {
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Language::VT_NAME, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> LanguageBuilder<'a, 'b> {
        ...
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Language::VT_NAME, name);
        }
        #[inline]
    ...
    impl<'a> Manifest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.directories {
                builder.add_directories(x);
            }
            if let Some(x) = args.files {
                builder.add_files(x);
            }
            if let Some(x) = args.languages {
                builder.add_languages(x);
            }
        ...
        pub fn bundles(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bundle<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bundle>>,
                >>(Manifest::VT_BUNDLES, None)
            }
        }
        #[inline]
        pub fn languages(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Language<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Language>>,
                >>(Manifest::VT_LANGUAGES, None)
            }
        }
        #[inline]
        pub fn files(
            ...
            unsafe {
                ...
                >>(Manifest::VT_FILES, None)
            }
        }
        #[inline]
        pub fn directories(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Directory<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Directory>>,
                >>(Manifest::VT_DIRECTORIES, None)
            }
        }
        #[inline]
        pub fn keys(
    ...
    impl flatbuffers::Verifiable for Manifest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Bundle>>,
                >>("bundles", Self::VT_BUNDLES, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Language>>,
                >>("languages", Self::VT_LANGUAGES, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<File>>,
                >>("files", Self::VT_FILES, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Directory>>,
                >>("directories", Self::VT_DIRECTORIES, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Key>>,
                >>("keys", Self::VT_KEYS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Param>>,
    ...
    pub struct ManifestArgs<'a> {
        pub bundles: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bundle<'a>>>,
            >,
        >,
        pub languages: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Language<'a>>>,
            >,
        >,
        pub files: Option<
            flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<File<'a>>>>,
        >,
        pub directories: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Directory<'a>>>,
            >,
        >,
        pub keys: Option<
            flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Key<'a>>>>,
        >,
        pub params: Option<
            flatbuffers::WIPOffset<
    ...
    impl<'a: 'b, 'b> ManifestBuilder<'a, 'b> {
        ...
        pub fn add_bundles(
            ...
            bundles: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Bundle<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Manifest::VT_BUNDLES, bundles);
        }
        #[inline]
        pub fn add_languages(
            &mut self,
            languages: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Language<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Manifest::VT_LANGUAGES, languages);
        }
        #[inline]
        pub fn add_files(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Manifest::VT_FILES, files);
        }
        #[inline]
        pub fn add_directories(
            &mut self,
            directories: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Directory<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Manifest::VT_DIRECTORIES,
                directories,
            );
        }
        #[inline]
        pub fn add_keys(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Manifest::VT_KEYS, keys);
        }
        #[inline]
        pub fn add_params(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Manifest::VT_PARAMS, params);
        }
        #[inline]
    ...
    pub fn size_prefixed_root_as_manifest(
        buf: &[u8],
    ) -> Result<Manifest, flatbuffers::InvalidFlatbuffer> {
